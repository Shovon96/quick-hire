...
export default function Hero() {
    return (
        <section className="relative w-full h-198.5 mx-auto overflow-hidden bg-[#F8F8FD]">
            ...
            {/* Content Container */}
            <div style={{}} className="absolute top-0 left-0 right-0 z-10 h-full w-360 mx-auto flex items-center px-31">

                <div className="w-160">

                    {/* Heading */}
                    <div className="mb-6">
                        <h1 style={{ fontFamily: 'var(--font-clash)' }} className="text-[72px] leading-18 font-semibold text-[#25324B]">
                            Discover <br />
                            more than <br />
                    ...
                    {/* Description */}
                    <p className="font-epilogue text-[#515B6F] text-[20px] font-400 leading-7 mb-8 w-130">
                        Great platform for the job seeker that searching for new career
                        heights and passionate about startups.
                    </p>

                    {/* Search Bar */}
                    <div className="flex justify-between gap-4 items-center w-213 h-22.25 bg-white shadow-md p-4">
                        ...
                        {/* Divider */}
                        <div className="w-px h-8 bg-[#E4E5EC]" />
                        ...
                        {/* Button */}
                        <button className="py-3.5 px-6.75 bg-[#4640DE] text-white text-[18px] font-bold cursor-pointer">
                            Search my job
                        </button>
                    </div>
